/*
 * HAPAccessoryServer_Defines.h
 *
 */

#ifndef HAPACCESSORYSERVER_DEFINES_H_
#define HAPACCESSORYSERVER_DEFINES_H_
...
// HAPMethod
typedef enum _HAPMethod {
	HAPMethod_PairSetupNonMFI	=	0,
	HAPMethod_PairSetup			=	1,
	HAPMethod_PairVerify		=	2,
	HAPMethod_AddPairing		=	3,
	HAPMethod_RemovePairing		=	4,
	HAPMethod_ListPairings		=	5,
} HAPMethod;

// Success, This is not normally included in a message. Absence of a status item implies success
#define kTLVError_NoErr   				0x00

// Generic error to handle unexpected errors
#define kTLVError_Unknown	  			0x01
...
#define kTLVError_Busy		   		    0x07


#endif /* HAPACCESSORYSERVER_DEFINES_H_ */
